<html> <meta charset="utf-8">
	...
	<head> <title>Quiz Stream</title>
		<?php																			//PHP Teil
			...
			$lesen5 = fopen("Spieler2.csv", "r");										//Einlesen der Spieler2.csv, beinhaltet answerId, isCorrect und $totalPoints
			...
			while($i<=264){
				...
				if($zeile4 >= $ii){
					...
					$s1 = "normal"; 														//zentriert den Text "Warte auf Antwort"
					$antwort3 ="Warte auf Antwort";
				}
				if($zeile5 >= $ii){ 												// Das Gleiche wie oben nur mit Spieler 2
	...
	<body >
		<script language="JavaScript">
			window.setTimeout("location.reload()",3000);								//Autorefrech alle 3 Sekunden
		</script>
	</body>
</html>
